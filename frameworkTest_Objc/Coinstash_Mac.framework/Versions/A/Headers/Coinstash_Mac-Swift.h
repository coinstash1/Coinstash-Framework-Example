...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Coinstash_Mac",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13Coinstash_Mac9Coinstash")
...
SWIFT_PROTOCOL("_TtP13Coinstash_Mac17CoinstashDelegate_")
@protocol CoinstashDelegate
