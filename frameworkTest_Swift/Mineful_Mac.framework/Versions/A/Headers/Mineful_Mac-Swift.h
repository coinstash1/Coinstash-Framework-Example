...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Mineful_Mac",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11Mineful_Mac7Mineful")
@interface Mineful : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, strong) id <MinefulDelegate> _Nullable delegate;)
+ (id <MinefulDelegate> _Nullable)delegate SWIFT_WARN_UNUSED_RESULT;
...
+ (NSInteger)currentCPU SWIFT_WARN_UNUSED_RESULT;
...
+ (BOOL)getWantsCredit SWIFT_WARN_UNUSED_RESULT;
+ (void)setWantsCredit:(BOOL)wantscredit;
+ (void)setParentViewControllerWithViewController:(NSViewController * _Nonnull)viewController;
+ (void)showIntroView;
...
SWIFT_PROTOCOL("_TtP11Mineful_Mac15MinefulDelegate_")
@protocol MinefulDelegate
